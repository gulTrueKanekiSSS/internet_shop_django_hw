...
from blog.views import PosterListView, PosterDetailView, PosterCreateView, PosterUpdateView, PosterDeleteView, UserPostsListView
...
urlpatterns = [
    ...
    path('user_posts/', UserPostsListView.as_view(), name='user_posts'),
